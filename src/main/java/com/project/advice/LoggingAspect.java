...
public class LoggingAspect {
    ...
    @After("execution(* com.project.test.component.ComponentServiceImpl.getComponentById(..))")
    ...
    @After("execution(* com.project.test.service_action.ServiceActionImpl.addServiceAction(..))")
    ...
    @After("execution(* com.project.test.warehouse.WarehouseServiceImpl.getWareHouseById(..))")
